...
func TestImaging(t *testing.T) {
	...
	defer func(){aboveColour = color.RGBA{0,0,0,0}}()
...
func TestI(t *testing.T) {
	...
	belowColour = color.RGBA{0,255,255,127}
...
/*  hal3 Sat 27 Feb 05:30:10 GMT 2016 go version go1.5.1 linux/386
=== RUN   TestNoise
...
=== RUN   TestStackPCMs
--- PASS: TestStackPCMs (0.58s)
=== RUN   TestMultiplexTones
--- PASS: TestMultiplexTones (0.20s)
=== RUN   TestSaveLoadSave
--- PASS: TestSaveLoadSave (0.30s)
=== RUN   TestPiping
--- PASS: TestPiping (0.02s)
=== RUN   TestImagingSine
--- PASS: TestImagingSine (0.38s)
=== RUN   TestImaging
...
PASS
ok  	_/home/simon/Dropbox/github/working/signals	3.308s
Sat 27 Feb 05:30:15 GMT 2016 */
