...
// Composite is a PeriodicLimitedFunction, generated by adding together Function(s). (Function's can be PeriodicLimitedFunction's, so this can be hierarchical.)
// Composite's MaxX() comes from the largest contstituent MaxX(), (0 if no contained Functions are LimitedFunctions.)
