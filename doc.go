...
Functions are generally procedural, calculated as needed, meaning changes in parameters, or arrangment, effective returned values of existing types.
...
PeriodicFunction :- a Function with an additional method Period(), reciprocal of any fundamental frequency, (or sampling for PCM), delta x.
